/*
 * 4. *Write a program to `compare the performance` of insertion sort, selection sort, 
 * quicksort for `int`, `double` and `string` values.
 * Check also the following cases: random values, sorted values, values sorted in reversed order.
 */
namespace SortingAlgorithmsPerformanceTest
{
    using System;
    using System.Diagnostics;
    using System.Linq;
    using SortingAlgorithmsPerformanceTest.Algorithms;
