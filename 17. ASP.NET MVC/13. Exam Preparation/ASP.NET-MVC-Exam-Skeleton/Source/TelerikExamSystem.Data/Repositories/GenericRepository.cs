namespace TelerikExamSystem.Data.Repositories
{
    using System;
    ...
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public GenericRepository(ITelerikExamSystemDbContext context)
        {
            if (context == null)
            {
        ...
        protected ITelerikExamSystemDbContext Context { get; set; }
